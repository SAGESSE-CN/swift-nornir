...
class ExConversation: SIMChatBaseConversation {
    ...
    required init(receiver: SIMChatUserProtocol, manager: SIMChatManagerProtocol) {
    ...
    override func sendMessage(message: SIMChatMessageProtocol, isResend: Bool, closure: SIMChatMessageHandler?) {
        SIMLog.trace()
    ...
    override func loadHistoryMessages(last: SIMChatMessageProtocol?, count: Int, closure: SIMChatMessagesHandler?) {
        SIMLog.trace()
...
//            }
    ...
    func convert(message: TIMMessage) -> SIMChatMessageProtocol {
