...
class ExManager: SIMChatBaseManager {
    ...
    /// 所有的会话
    ///
    override func allConversations() -> Array<SIMChatConversationProtocol> {
        SIMLog.trace()
    ...
    ///
    override func removeConversationWithReceiver(receiver: SIMChatUserProtocol) {
        SIMLog.trace()
        
        super.removeConversationWithReceiver(receiver)
    ...
    static var sharedInstance: SIMChatManagerProtocol = ExManager()
}
