...
internal class SAIEmoticonBackgroundView: UIView {
    ...
    private func _init() {
        ...
        addConstraint(_SAEmoticonLayoutConstraintMake(_leftView, .left, .equal, self, .left, priority: UILayoutPriority(rawValue: 751)))
        ...
        addConstraint(_SAEmoticonLayoutConstraintMake(_rightView, .right, .equal, self, .right, priority: UILayoutPriority(rawValue: 751)))
