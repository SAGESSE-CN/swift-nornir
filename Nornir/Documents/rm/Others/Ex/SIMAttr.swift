...
//    }
//    
//    func setter(_ op: ((T) -> Void)?) -> Self {
//        self.setter = op
//        return self
//    }
//    func getter(_ op: ((T) -> Void)?) -> Self {
//        self.getter = op
//        return self
//    }
//    
//    func willSet(_ op: ((T?) -> Void)?) -> Self {
//        self.willSet = op
//        return self
//    }
//    func didSet(_ op: ((T?) -> Void)?) -> Self {
//        self.didSet = op
//        return self
//    }
//    
...
//    }
//    
//    func lazyer(_ op: @escaping (Void) -> T) -> Self {
//        self.lazyer = op
//        self.storage = nil
//        return self
//    }
...
//    }
//    
//    func lazyer(_ op: @escaping ((T) -> Void) -> Void) -> Self {
//        self.lazyer = op
//        self.storage = nil
//        self.storaging = false
//        return self
