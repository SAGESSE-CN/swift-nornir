...
public class SIMChatMediaAudioRecorder: NSObject, SIMChatMediaRecorderProtocol, AVAudioPlayerDelegate {
...
//                return // 别人使用了
//            }
//            guard !(SIMChatMediaAudioRecorder.retainInstance?.playing ?? false) else {
//                return // 正在播放
//            }
//            SIMLog.trace()
